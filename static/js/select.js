const regionesOrdenadas = {
	...
	"Valparaíso": ["Valparaíso", "Viña del Mar", "Concón", "Quilpué", "Villa Alemana", "Limache", "Olmué", "Petorca", "La Ligua", "Cabildo", "San Antonio", "San Felipe", "Los Andes", "Llay-Llay", "Putaendo", "Santa María"],
	"O'Higgins": ["Rancagua", "Machalí", "Olivar", "Pichidegua", "Pichilemu", "Rengo", "Requínoa", "San Fernando", "San Vicente", "Malloa", "Doñihue", "Coltauco", "La Estrella", "Las Cabras", "Peumo", "Peralillo", "Quinta de Tilcoco", "Codegua"],
	...
	"Biobío": ["Concepción", "Chiguayante", "Hualpén", "Hualqui", "Lota", "Penco", "San Pedro de la Paz", "Talcahuano", "Tomé", "Coronel", "Laja", "Los Ángeles", "Mulchén", "Nacimiento", "Negrete", "San Rosendo", "Santa Bárbara", "Tucapel", "Yumbel", "Angol", "Collipulli", "Curacautín", "Ercilla", "Lonquimay", "Melipeuco", "Nielol", "Victoria"],
	...
	"Región Metropolitana": ["Santiago", "Las Condes", "Providencia", "Ñuñoa", "Vitacura", "La Florida", "Peñalolén", "San Miguel", "San Joaquín", "Macul", "La Reina", "Recoleta", "Independencia", "Cerrillos", "Cerro Navia", "Pudahuel", "Renca", "Quilicura", "Huechuraba", "Lo Barnechea", "El Bosque", "San Ramón", "La Pintana", "Lo Prado", "Maipú", "San Bernardo", "Pedro Aguirre Cerda", "Estación Central", "La Granja", "San José de Maipo"],
